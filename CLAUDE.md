...
| *Sonic Racing: CrossWorlds* `PPSA08804` | rung 1 — the SEGA logo renders; the composite then goes uniform (#2013). The rwlock deadlock is fixed (#2012) | `docs/SONIC_CROSSWORLDS_STATUS.md` |
