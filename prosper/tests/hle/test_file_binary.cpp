...
int main() {
    ...
    // Deliberately NOT tests/fixtures/test_scratch.h (#1613). What this fixture needs is a filesystem that
    ...
    // Deliberately NOT tests/fixtures/test_scratch.h — see the chmod fixture above for why (#1613).
