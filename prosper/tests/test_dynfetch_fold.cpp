...
int main() {
    ...
    // whole post-movie composite sampled one texel (#2006). Both polarities are asserted: a fix that
    // merely defaulted the saved mask to "all lanes" would pass the vertex arm and fail this one.
