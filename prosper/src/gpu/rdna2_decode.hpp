...
// GFX10.3 raw MUBUF store opcodes shared by descriptor discovery and emission. These are inline
// constants, so descriptive names compile to the same immediate comparisons as the old literals.
