...
PHASES = [
    ...
    # optimise. Whatever CPU tiling remains then appears as layout's `unattributed` row, which is the
    # honest place for it. Measured 2026-09-15 on PPSA03831: layout 6,551 ms, retile copy 6,541 ms.
