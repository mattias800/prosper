...
> `source-distinct=1`). Fixed in #3125 by answering as the PS5 sibling does: an explicit zero-hit
> result and SCE_OK. Restored to `max_nonblack=1.0000`, `source-distinct=18`.
>
> **`## Ruled out` for this regression, so none of it is re-derived:**
>
> | dead hypothesis | evidence that killed it | cost |
> |---|---|---|
