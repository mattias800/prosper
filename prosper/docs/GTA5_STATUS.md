...
The tier (`kFragmentWavePartialWaveExactReasons`, `rdna2_to_spirv.hpp`; first scoped to this title,
since #3797 on every native-vote title) runs a module at the host's
