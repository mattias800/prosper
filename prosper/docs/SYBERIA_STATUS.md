...
unrelated to the atlas, with zero overlap or unrealized draws. The blanket boundary therefore forces
guest visibility too early. The next discriminator must retain the retired atlas identity through
the remaining draws in each submit and locate the first true graphics overlap, or prove there is none
before submit end. Even that broader post-realization result will not by itself cover descriptor,
index, or shader reads performed while realizing a draw.
