...
**Rung 2 reached: the title screen renders.** At master `b182d917`, nine default-launch arms on an
...
`ea299e97` + the mutex-encoding fix reached it and survived their whole 12 s bound; one hit #1945
...
The black-frame era is over. On master `6a40d191` the default environment
...
**Current — the popup, and the fault that follows it (2026-08-04, master `6a40d191`):**
