...
| *Dragon Quest VII Reimagined* | `PPSA17942` | Unreal Engine 4 | 🚧 Rung 3 — **the field state in Pilchard Bay**: minimap, party block, area-entry banner and the player character, across 144 frames over 588 s. Locomotion is measured, not inferred: minimap displacement ≥ 2 px in 7 of 8 stick windows against 0 of 8 neutral. The blocker was never a control but the route's patience — the opening chapter needs ~450 confirms, and the routes that gave it ~40 reached the field **zero** times. The composite is severely degraded and intermittent: 25% of those frames render a recognisable scene, the rest collapse to white, black or flat blue (#1486 / #1588). Route: `scripts/dragon-quest-vii/reach-field-control.pad` | [#1874](https://github.com/mattias800/prosper/issues/1874) |
