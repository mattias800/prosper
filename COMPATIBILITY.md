...
| *Space Adventure Cobra — The Awakening* | `PPSA17337` | Unity / IL2CPP | 🚧 Tutorial combat on the reviewed revision. The black-on-master regression is **fixed** — the desert level renders again, but **without its HUD and with a seam in the sky**, and the `cobra-gameplay` guard is still red on structure alone ([#2899](https://github.com/mattias800/prosper/issues/2899)) | [#1870](https://github.com/mattias800/prosper/issues/1870) |
