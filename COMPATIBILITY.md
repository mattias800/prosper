...
| *BALAN WONDERWORLD* | `PPSA02058` | Unreal Engine 4 | 🔬 Rung 2 — a routed run answers the language menu's own *"Are you sure you want to change the game language to English?"* modal, which needs **Down** and not Cross, and reaches the title screen at t≈15 s, the main menu, and the opening story cutscene rendered **in engine** at 4K with no video decode. No stage loads in 717 s, and the wrong composite still takes most frames ([#2932](https://github.com/mattias800/prosper/issues/2932)). Route: `prosper/scripts/balan-PPSA02058/` | [#2882](https://github.com/mattias800/prosper/issues/2882) |
